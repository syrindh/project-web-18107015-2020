 ...
 *   https://datatables.net/download/#bs4/dt-1.10.22/r-2.2.6/sb-1.0.0/sp-1.2.1
 *
 * Included libraries:
 *   DataTables 1.10.22, Responsive 2.2.6, SearchBuilder 1.0.0, SearchPanes 1.2.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.22/r-2.2.6/sb-1.0.0/sp-1.2.1",
